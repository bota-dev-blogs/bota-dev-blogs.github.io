...
cover:
  src: "/media/gifs/from-chinese-to-english-and-a-detour-into-moroccan-arabic/pipeline-2/diagram.gif"
  alt: "Animated AI video language transformation pipeline diagram"
  width: 2096
  height: 620
  fit: "contain"
media:
  ...
  - title: "Project explainer"
    ...
    type: "image"
    note: "Pipeline 1 explainer GIF generated from the article draft."
---

## Project Overview

**AI Video Language Transformation** converts Chinese-language GitHub tutorial videos into English while preserving the original visual track and cloning the speaker's voice. The goal is simple to describe and hard to execute: same video, new language, familiar speaker identity.

The system chains together transcription, translation, speaker diarization, speech synthesis, audio alignment, and video merging. Each stage has to work, but the final quality depends on how well the stages hand timing, speaker identity, terminology, and audio constraints to one another.

![AI video language transformation pipeline diagram](/media/gifs/from-chinese-to-english-and-a-detour-into-moroccan-arabic/pipeline-2/diagram.gif)

After the Chinese-to-English pipeline worked, the project took a harder detour: testing what it would take to fine-tune voice cloning for Darija, Moroccan Arabic. That experiment did not produce a production-ready voice model, but it exposed the real bottlenecks behind low-resource speech synthesis.
...
Before describing the fine-tuning attempt, it is worth situating it within what already exists.
